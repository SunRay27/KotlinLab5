...
internal class ShapeCollectorTest {
    ...
    @Test
    fun addAll() {
        val shapeList: MutableList<ColoredShape2D> = mutableListOf()
    ...
    fun getSorted() {
        ...
        val redBorderSorted = collector.getSorted(compareBy { it.borderColor.r })
        for (i in 1 until redBorderSorted.count())
            assertTrue(redBorderSorted[i - 1].borderColor.r <= redBorderSorted[i].borderColor.r)
    }
}